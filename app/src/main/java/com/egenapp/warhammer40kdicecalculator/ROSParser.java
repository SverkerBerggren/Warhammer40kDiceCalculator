...
public class ROSParser
{
    ...
    public com.egenapp.warhammer40kdicecalculator.DatasheetModeling.Army ParseArmy(String ArmyData)
    {
        com.egenapp.warhammer40kdicecalculator.DatasheetModeling.Army ReturnValue = new Army();
        try{
